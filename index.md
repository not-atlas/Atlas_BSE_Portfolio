...
**Added code to starter code, Starter code from (https://lafvintech.com/pages/tutorials):**
I defined the pin numbers for the L298N motor driver. I also changed the input, so the arduino would detect if the PS2 joystick was pressed down or not.
